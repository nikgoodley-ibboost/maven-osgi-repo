...
public class DirectoryOsgiPluginTest {
	...
	private DirectoryOsgiPlugin plugin=new DirectoryOsgiPlugin(TestUtil.getFileOfResource("mockrepo-2/org.maven.ide.eclipse.dependency_tree_0.12.1.20110112-1712"));
