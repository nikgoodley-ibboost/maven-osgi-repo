...
public class ContentTestUtil {
	...
	public static void assertGeneratesXMLContent(String expected, Content content) throws IOException, SAXException {
	...
	private static String formatXmlInternal(String xml) throws TransformerConfigurationException,
