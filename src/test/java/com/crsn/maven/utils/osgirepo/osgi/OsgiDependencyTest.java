...
public class OsgiDependencyTest {
	...
	public void willResolvePluginIfMatching() {
		OsgiDependency dependency = new OsgiDependency("org.eclipse.xtext.xtend2.lib", new VersionRange(new Version(
				"1.0"), true, null, false));
	...
	public void wontResolvePluginOutsideVersionRange() {
		assertFalse(new OsgiDependency("org.eclipse.xtext.xtend2.lib", new VersionRange(new Version("1.0"), true,
				new Version("1.0"), true)).isResolvedBy(plugin));
	}

	@Test
	public void wontResolvePluginWithDifferentName() {
		assertFalse(new OsgiDependency("unknown", new VersionRange(new Version("1.0"), true, null, true))
				.isResolvedBy(plugin));
	}
